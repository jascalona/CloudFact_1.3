            ...
            <div class="container-componet-installation">
                ...
                <article class="card-install">
                    <div class="item-install-right">
                        <div class="cont-top">
                            <h6>Registro de Desinstalación</h6>
                            <small>Por favor ingrese los datos del equipo en el siguiente formulario!</small>
                        </div>
                        <!--INPUT GROUP FORM-->

                        <form action="{{ route('desinstalation.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-text mb-3 mt-5 ">Backup
                            </div>

                            <div style="display: flex; align-items: center;" class="form-check ">
                                <input class="form-check- w-auto" type="radio" name="backup" id="radioDefault1" value="Si">
                                <label class="form-check-label mt-2" for="radioDefault1">Si</label>
                            </div>
                            <div style="display: flex; align-items: center;" class="form-check">
                                <input class="form-check- w-auto" type="radio" name="backup" id="radioDefault2" value="No"
                                    checked>
                                <label class="form-check-label mt-2" for="radioDefault2">No</label>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="date_desinsta" type="date" class="form-control" id="exampleFormControlInput1"
                                    placeholder="">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Contador de Desinstalación
                                    B/N</label>
                                <input name="cont_desin_bn" type="number" class="form-control" id="exampleFormControlInput1"
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Contador de Desinstalación
                                    Color</label>
                                <input name="cont_desin_color" type="number" class="form-control"
                            ...
                            <div class="btn-carga">
                                <button type="submit" class="btn btn-dark" name="new_desin" value="submit">Cargar</button>
                            </div>
                        </form>
